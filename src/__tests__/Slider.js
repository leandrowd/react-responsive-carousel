...
describe("Slider", function() {
 ...
 //  	});
	...
	// 	it("Should update the position of the Slider if selectedItem is changed", function () {
	...
	// 	it("Should limit the position of the Slider firstItem to the `lastPosition`", function () {
	// 		TestUtils.Simulate.click(componentInstance.refs['itemImg2']);
	// 		expect(componentInstance.state.selectedItem).toBe(2);
	// 		expect(componentInstance.state.firstItem).toBe(2);
