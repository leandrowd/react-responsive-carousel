        ...
        return (
            <div className={this.props.className} ref={this.setCarouselWrapperRef}>
                <div className={klass.CAROUSEL(true)} style={{width: this.props.width}}>
                    <button type="button" className={klass.ARROW_PREV(!hasPrev)} onClick={this.decrement} role="presentation" aria-label="mobile navigation"/>
                    ...
                    <button type="button" className={klass.ARROW_NEXT(!hasNext)} onClick={this.increment} role="presentation" aria-label="mobile navigation"/>
