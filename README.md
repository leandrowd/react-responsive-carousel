...
| renderArrowNext                          | `function`                   | Render custom next arrow. Receives a click handler, a `boolean` that shows if there's a next item, and the accessibility label as arguments.                                                                      |
