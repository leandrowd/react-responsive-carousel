    ...
    function Carousel(props) {
        ...
        _this.handleClickItem = function (index, item) {
            ...
            if (index !== _this.state.selectedItem) {
                var itemCount = _react2.default.Children.count(_this.props.children) - 1;

                if (index === 0 && itemCount === _this.state.selectedItem) {
                    index = _this.state.selectedItem + 1;
                } else if (index === itemCount && _this.state.selectedItem === 0) {
                    index = -1;
                }

                _this.moveTo(index, false);
            }
        };
