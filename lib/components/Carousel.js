...
module.exports = React.createClass({
    ...
    updateSizes:function () {
        ...
        this.wrapperSize = this.isHorizontal ? this.itemSize * this.props.children.size : this.itemSize;
    },
    ...
    onSwipeMove:function(delta) {
        ...
        var finalBoundry = - (this.props.children.size - 1) * 100;
    ...
    moveTo:function (position) {
        ...
        position = position >= this.props.children.size - 1 ? this.props.children.size - 1 : position;
    ...
    renderStatus:function () {
        ...
        return React.createElement("p", {className: "carousel-status"}, this.state.selectedItem + 1, " of ", this.props.children.size);
    },
    ...
    render:function () {
        var itemsLength = this.props.children.size;
