...
var Carousel = function (_Component) {
    ...
    function Carousel(props) {
        ...
        _this.autoPlay = function () {
            if (!_this.state.autoPlay || _this.childrenLength <= 1) {
                return;
            }
        ...
        _this.updateSizes = function () {
            ...
            _this.setState({
                itemSize: itemSize,
                wrapperSize: isHorizontal ? itemSize * _this.childrenLength : itemSize
            });
        ...
        _this.onSwipeMove = function (delta) {
            ...
            var finalBoundry = _this.getPosition(_this.childrenLength - 1, true);
            ...
            if (_this.props.infiniteLoop) {
                if (_this.state.selectedItem === 0 && position > -100) {
                    position -= _this.childrenLength * 100;
                } else if (_this.state.selectedItem === _this.childrenLength - 1 && position < -_this.childrenLength * 100) {
                    position += _this.childrenLength * 100;
                }
            }
            position += '%';
        ...
        _this.moveTo = function (position) {
            var lastPosition = _this.childrenLength - 1;
            var needClonedSlide = _this.props.infiniteLoop && !_this.state.swipeLoop && (position < 0 || position > lastPosition);
        ...
        _this.childrenLength = _react.Children.count(_this.props.children);
        return _this;
    }
    ...
    _createClass(Carousel, [{
        ...
        key: 'getPosition',
        value: function getPosition(index, swiping) {
            if (this.props.centerMode && this.props.axis === 'horizontal') {
                var currentPosition = -index * this.props.centerSlidePercentage;
                var lastPosition = this.childrenLength - 1;
        ...
        key: 'renderFirstClone',
        value: function renderFirstClone() {
            var item = _react.Children.toArray(this.props.children)[0];
            var slideProps = {
                key: 'itemKey-1',
                className: _cssClasses2.default.ITEM(true, 0 === this.state.selectedItem)
            };
        ...
        key: 'renderLastClone',
        value: function renderLastClone() {
            var item = _react.Children.toArray(this.props.children)[this.childrenLength - 1];
            var slideProps = {
                key: 'itemKey+1',
                className: _cssClasses2.default.ITEM(true, this.childrenLength - 1 === this.state.selectedItem)
            };
        ...
        value: function renderStatus() {
            ...
            return _react2.default.createElement(
                ...
                this.props.statusFormatter(this.state.selectedItem + 1, this.childrenLength)
            );
        }
    }, {
        key: 'renderThumbs',
        ...
        value: function render() {
            ...
            var canShowArrows = this.props.showArrows && this.childrenLength > 1;

            // show left arrow?
            var hasPrev = canShowArrows && (this.state.selectedItem > 0 || this.props.infiniteLoop);
            // show right arrow
            var hasNext = canShowArrows && (this.state.selectedItem < this.childrenLength - 1 || this.props.infiniteLoop);
            ...
            var transitionTime = this.state.loop ? '0ms' : this.props.transitionTime + 'ms';
