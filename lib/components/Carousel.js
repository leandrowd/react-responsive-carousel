...
module.exports = React.createClass({
    ...
    triggerOnChange:function (index, item) {
    ...
    renderThumbs:function () {
        ...
        return (
            React.createElement(Thumbs, {onSelectItem: this.onThumbClick, selectedItem: this.state.selectedItem}, 
                this.props.children
            )
        );
    }, 
        ...
        return (
            React.createElement("div", {className: this.props.className}, 
                React.createElement("div", {className: klass.CAROUSEL(true)}, 
                    ...
                    React.createElement("div", {className: klass.WRAPPER(true, this.props.axis), ref: function(node)  {return this.itemsWrapper = node;}.bind(this)}, 
