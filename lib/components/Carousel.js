    ...
    _createClass(Carousel, [{
        ...
        value: function render() {
            ...
            if (isHorizontal) {
                ...
                swiperProps.onSwipeDown = this.props.verticalSwipe === "natural" ? this.onSwipeDownWard : this.onSwipeUpWard;
...
var _initialiseProps = function _initialiseProps() {
    ...
    this.onSwipeUpWard = function () {
        _this5.increment(1, true);
    };

    this.onSwipeDownWard = function () {
        _this5.decrement(1, true);
    };
